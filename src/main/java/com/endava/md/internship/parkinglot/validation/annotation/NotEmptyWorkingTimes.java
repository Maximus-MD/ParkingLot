...
@Constraint(validatedBy = NotEmptyWorkingTimesValidator.class)
public @interface NotEmptyWorkingTimes {
    String message() default "{message.empty-parking-working-times}";
