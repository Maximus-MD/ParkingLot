...
@Constraint(validatedBy = UniqueParkingAddressValidator.class)
public @interface UniqueParkingAddress {

    String message() default "{message.duplicate-parking-address}";
